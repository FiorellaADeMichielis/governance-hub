...
export const LanguageSelector = ({ className = '', showIcon = true }: LanguageSelectorProps) => {
  ...
  return (
    <div className={`inline-flex items-center gap-1.5 p-1 bg-stone-100 dark:bg-neutral-900/80 border border-stone-200 dark:border-stone-700 rounded-lg text-xs ${className}`}>
      {showIcon && (
